...
public class DinnerChart extends AppCompatActivity {
    ...
    private void viewBreakfast(String date){
        Cursor crs = dinnerDB.getSingleBreakfast(date);
    ...
    private void listRefresh(){
        ...
        dinnerList.setAdapter(chartListAdapter);
        i=0;

        dinnerList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {

                Toast.makeText(DinnerChart.this, "Item Deleted", Toast.LENGTH_SHORT).show();
